if ( CLIENT ) then
	...
	SWEP.InvIcon = Material( "icons/icon_d.png" )
...
SWEP.ViewModel = "models/weapons/scpid_d.mdl"
SWEP.WorldModel = "models/weapons/scpid_d_worldmodel.mdl"
...
local angle_offset = Angle( -90, 180, -90 )
