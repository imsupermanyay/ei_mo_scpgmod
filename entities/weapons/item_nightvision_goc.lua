...
if ( CLIENT ) then
  ...
  SWEP.InvIcon = Material( "nextoren/gui/icons/pnv_white.png" )
...
SWEP.ViewModel		= "models/imperator/items/nightvision/v_night_vision_white.mdl"
			...
			timer.Simple(1.2, function()
				...
				if ( self.Owner:Alive() ) then
					...
					if ( !banned_models[ self.Owner:GetModel() ] ) then
						...
						Bonemerge( "models/imperator/items/nightvision/bonemerge_nvg_forface_white.mdl", self.Owner )
