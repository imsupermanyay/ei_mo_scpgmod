...
if not xgui.settings.moduleOrder then xgui.settings.moduleOrder = { "菜单", "权限组", "地图", "设置", "封禁" } end
if not xgui.settings.settingOrder then xgui.settings.settingOrder = { "沙盒", "服务端", "客户端" } end
...
function xgui.init( ply )
	...
	local infoLabel = string.format( "\nULX 管理 工具 :: XGUI - Ulysses 团队 |  ULX版本 %s  |  ULib版本 %s  |  中文汉化By TWAAA", ULib.pluginVersionStr("ULX"), ULib.pluginVersionStr("ULib") )
